var convertChildren = function(children, param, namespace, iBatisMapper, isRoot) {
  ...
  if (children.type == 'text') {
    ...
    case 'dynamic':
      if (!isRoot) throw new Error("Dynamic elements are should be used in root xml.");
      return convertDynamic(children, param, namespace, iBatisMapper);
      break;
    case 'isnotnull':
      if (isRoot) throw new Error("Dynamic elements are should be included in <dynamic> tag.");
